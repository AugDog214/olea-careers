...
export const faqEntries = [
  ...
  {
    en: ['Does Olea provide marketing and design services for agents?', 'The brokerage does not provide marketing or design services. As a courtesy, it may share agent listings and wins through its channels. Agents can use the office content room to create their own content and remain responsible for their business marketing.'],
    es: ['¿Olea proporciona servicios de marketing y diseño para agentes?', 'La agencia no proporciona servicios de marketing ni diseño. Como cortesía, puede compartir propiedades y logros de los agentes en sus canales. Los agentes pueden usar la sala de contenido para crear sus publicaciones y siguen siendo responsables del marketing de su negocio.'],
  },
  {
    en: ['Which Southwest Florida communities does The Olea Group serve?', 'The Olea Group is based in Cape Coral and serves Southwest Florida, including Fort Myers, Lehigh Acres, North Fort Myers, and Lee County. A confidential recruiting conversation can help you discuss how your local business fits the brokerage’s independent-agent model.'],
    es: ['¿Qué comunidades del suroeste de Florida atiende The Olea Group?', 'The Olea Group tiene su sede en Cape Coral y atiende el suroeste de Florida, incluidos Fort Myers, Lehigh Acres, North Fort Myers y Lee County. Una conversación confidencial puede ayudarte a evaluar cómo encaja tu negocio local en el modelo de agentes independientes.'],
  },
  {
