...
export const strings = {
  ...
  'hero.next': { en: 'Next slide', es: 'Siguiente imagen' },
  'hero.pause': { en: 'Pause slideshow', es: 'Pausar presentación' },
  'hero.resume': { en: 'Play slideshow', es: 'Reproducir presentación' },
