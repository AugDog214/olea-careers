...
const copy = {
  en: {
    ...
    feeContact: 'Curious about the monthly fee? Reach out to Heidy to chat about the brokerage.',
  ...
  es: {
    ...
    feeContact: '¿Tienes curiosidad sobre la cuota mensual? Comunícate con Heidy para conversar sobre la agencia.',
